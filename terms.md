...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named Charades Vs Alias
...
This app is licensed, not sold, to you by the Company for use strictly in accordance with the terms of this agreement.  
...
- Modify, copy, publicly display, distribute, or create derivative works from the Application.
- Use the Application for any unlawful, abusive, or unauthorized purpose.
- Sell, rent, lease, or sublicense the Application or any part of it.

---

## Consent to Data Collection

By using the Application, you consent to the collection and processing of data as described in our [Privacy Policy](https://yourdomain.com/privacy-policy).  

We may collect anonymized analytics (e.g., Google Firebase, Sentry), crash logs, and usage data to improve performance and Application reliability.
...
You may terminate it by uninstalling the Application.  
...
To the fullest extent permitted by law, the Company shall not be liable for any indirect, incidental, special, or consequential damages arising out of your use or inability to use the app.
